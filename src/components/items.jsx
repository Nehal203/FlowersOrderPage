export const menuData = {
    Roses: [
        ...
        { id: 4, name: "Pink Shaded White Roses in Glass Vase", price: 149, img: '/images/4.PinkShadedWhiteRosesinGlassVase.jpg' },
    ...
    Gerbera: [
        { id: 166, name: "Rose And Carnation Birthday Flower", price: 79, img: '/images/1.RoseAndCarnationBirthdayFlower.png' },
        { id: 167, name: "Gerberas and Pink Roses Bouquet", price: 79, img: '/images/2.GerberasandPinkRosesBouquet.png' },
        { id: 168, name: "Mix Gerbera Flower Bouquet", price: 79, img: '/images/3.MixGerberaFlowerBouquet.png' },
        { id: 169, name: "Bunch of Mix Flowers", price: 79, img: '/images/4.BunchofMixFlowers.png' },
        { id: 170, name: "Gerbera Bouquet", price: 79, img: '/images/5.GerberaBouquet.png' },
        { id: 171, name: "Carnation with Gypsy Flower Bouquet", price: 79, img: '/images/6.CarnationwithGypsylowerBouqt.png' },
        { id: 172, name: "Gerberas Indulgence", price: 79, img: '/images/7.GerberasIndulgence.png' },
        { id: 173, name: "Mixed Flower Arrangement", price: 79, img: '/images/8.MixedFlowerArrangement.png' },
        { id: 174, name: "Mixed Gerbera Flower Vase", price: 79, img: '/images/9.MixedGerberalowerVase.png' },
        { id: 175, name: "colorful gerberas flower bouquet", price: 79, img: '/images/10.colorfulgerberasflowerbouquet.png' },
        { id: 176, name: "Yellow Gerbera Flower Bouquet", price: 79, img: '/images/11.YellowGerberalowerBouquet.png' },
        { id: 177, name: "Red And White Flowers Bunch", price: 79, img: '/images/12.RedAndWhiteFlowersBunch.png' },
        { id: 178, name: "Best Florist White Flowers", price: 79, img: '/images/13.BestFloristWhiteFlowers.png' },
        { id: 179, name: "mixed gerberas flower", price: 79, img: '/images/14.mixedgerberasflower.png' },
        { id: 180, name: "Gerbera Flower Bouquet", price: 79, img: '/images/15.GerberaFlowerBouquet.png' },
        { id: 181, name: "White and Yellow Gerbera Flower", price: 79, img: '/images/16.WhiteandYellowGerberaFlower.png' },
        { id: 182, name: "Mixed color Gerberas Bouquet", price: 79, img: '/images/17.MixedcolorGerberasBouquet.png' },
        { id: 183, name: "Mixed Gerberas Birthday Box", price: 79, img: '/images/18.MixedGerberasBirthdayBox.png' },
        { id: 184, name: "Pink gerberas", price: 79, img: '/images/19.Pinkgerberas.png' },
        { id: 185, name: "Spectral bonanza", price: 79, img: '/images/20.Spectralbonanza.png' },
        { id: 186, name: "Sunny Side Up", price: 79, img: '/images/21.SunnySideUp.png' },
        { id: 187, name: "UnboxBlissfulLove.png", price: 79, img: '/images/22.UnboxBlissfulLove.png' },
        { id: 188, name: "Vivid Memories", price: 79, img: '/images/23.VividMemories.png' },
        { id: 189, name: "White Lily Rose Gerbera Bouquet", price: 79, img: '/images/24.WhiteLilyRoseGerberaBouquet.png' },
    ],
    CarnationFLowers: [
        { id: 190, name: "Red Carnation Flower", price: 129, img: '/images/1.RedCarnationFlower.png' },
        { id: 191, name: "Red Carnation Flower", price: 129, img: '/images/2.8RedCarnationFlower.png' },
        { id: 192, name: "Carnation bouquet and chocolate combo", price: 129, img: '/images/3.carnationbouquetandchocolatecombo.png' },
        { id: 193, name: "Carnation flower with bawl", price: 129, img: '/images/4.Carnationflowerwithbawl.png' },
        { id: 194, name: "Best Carnation Jute Bouquet", price: 129, img: '/images/5.BestCarnationJuteBouquet.png' },
        { id: 195, name: "Carnation Flower With Dairymilk Chocolate", price: 129, img: '/images/6.CarnationFlowerWithDairymilkChocolate.png' },
        { id: 196, name: "Carnival pink flower bouquet", price: 129, img: '/images/7.carnivalpinklowerbouquet.png' },
        { id: 197, name: "carnation birthday flowers bouquet", price: 129, img: '/images/8.carnationbirthdayflowersbouquet.png' },
        { id: 198, name: "Red Carnation Flower Bouquet", price: 129, img: '/images/9.RedCarnationFlowerBouquet.png' },
        { id: 199, name: "Pink Bliss Floral Box", price: 129, img: '/images/10.PinkBlissFloralBox.png' },
        { id: 200, name: "Propose day Cake Flower Combo", price: 129, img: '/images/11.ProposedayCakelowerCombo.jpg' },
        { id: 201, name: "Red ‘N’ White Allure", price: 129, img: '/images/12.RedNWhiteAllure.png' },
        { id: 202, name: "Red Carnation Bouquet", price: 129, img: '/images/13.RedCarnationBouquet.png' },
        { id: 203, name: "Red N White Carnations", price: 129, img: '/images/14.RedNWhiteCarnations.png' },
        { id: 204, name: "Rose Carnation Mixed Bouquet", price: 129, img: '/images/15.RoseCarnationMixedBouquet.png' },
        { id: 205, name: "Roses n Carnations Bouquet", price: 129, img: '/images/16.RosenCarnationsBouquet.png' },
        { id: 206, name: "Sunshine Carnation Bouquet", price: 129, img: '/images/17.SunshineCarnationBouquet.png' },
        { id: 207, name: "Timeless Infatuation", price: 129, img: '/images/18.TimelessInfatuation.png' },
        { id: 208, name: "Together Forever Blooms", price: 129, img: '/images/19.TogetherForeverBlooms.png' },
        { id: 209, name: "Untouched Beauty", price: 129, img: '/images/20.UntouchedBeauty.png' },
    ],

    ChocolateBouquet: [
        { id: 210, name: "Chocolate Bouquet", price: 129, img: '/images/1.ChocolateBouquet.png' },
        { id: 211, name: "Bundle Of Joy", price: 129, img: '/images/2.BundlOfJoy.jpg' },
        { id: 212, name: "Pink Rose Bouquet With Cake", price: 129, img: '/images/3.PinkRoseBouquetWithCake.jpg' },
        { id: 213, name: "Dairy Milk Bouquet", price: 129, img: '/images/4.DairyMilkBouquet.png' },
        { id: 214, name: "Dairy Star Chocolate Bouquet", price: 129, img: '/images/5.DairyStarChocolateBouquet.png' },
        { id: 215, name: "Ferrero Rocher Chocolate Bouquet", price: 129, img: '/images/6.FerreroRocherChocolateBouquet.png' },
        { id: 216, name: "Dairy Milk Chocolate Combo", price: 129, img: '/images/7.DairyMilkChocolateCombo.png' },
        { id: 217, name: "Mixed Roses Chocolate Combo", price: 129, img: '/images/8.MixedRosesChocolateCombo.jpg' },
        { id: 218, name: "Delight Chocolate Bouquet", price: 129, img: '/images/9.DelightChocolateBouquet.png' },
